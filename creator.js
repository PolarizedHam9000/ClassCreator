...
function createDescription(ev){
  ...
  var newContent = document.createTextNode(ev.target.getAttribute("data-name"));
  newParagraph.appendChild(newContent);
  newParagraph.setAttribute("class","tooltip");
  newParagraph.setAttribute("style","width:" + ev.target.getAttribute("data-name").length * 13 + "px");
